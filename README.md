...
| | |
|---|---|
| **Касса** | PIN кассира на планшете, нал и безнал, чек за два касания. Смена кассира без переоткрытия смены. |
...
| Кассир | касса `/pos`, PIN `1234` (после того как владелец один раз открыл кассу на этом устройстве) |
