...
export type Messages = {
  ...
  errors: {
    ...
    api: {
      ...
      barista_not_on_shop: string;
      shift_already_closed: string;
      shift_close_fiscal_pending: string;
      shift_close_z_report_failed: string;
      shift_closed_no_cash_move: string;
      withdrawal_exceeds_cash: string;
      stock_item_not_found: string;
      sale_price_required: string;
      stock_forbidden: string;
      barista_receive_only: string;
      invalid_movement_type: string;
      regrade_target_not_found: string;
      transfer_item_not_found: string;
      quantity_must_be_positive: string;
      output_qty_must_be_positive: string;
      regrade_units_mismatch: string;
      shop_not_found: string;
      shop_forbidden: string;
      shop_disabled: string;
      insufficient_role: string;
      email_phone_taken: string;
      barista_not_found: string;
    };
  };
  units: {
    pack: string;
